...
/**
 * Send to kafka HttoLog obj
 */
public class HttpLog implements Serializable {
	private static final long serialVersionUID = 4469349773248320666L;
	
	public HttpLog(){}
	
	public HttpLog(String data) {
		setData(data);
	}
	...
	public void setSdk_version(String version) {
